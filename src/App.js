  ...
  return (
    <>
      ...
      <style>{`
        ...
        .cursor-ring.active { width: 100px; height: 100px; background: rgba(0,0,0,1); border: none; top: -50px; left: -50px; }
        .cursor-label { color: #fff; font-size: 10px; font-weight: 900; letter-spacing: 2px; text-transform: uppercase; }
        @media (max-width: 768px) { .cursor-dot, .cursor-ring { display: none; } * { cursor: auto !important; } }
      `}</style>
    </>
  );
};
  ...
  return (
    <header className="site-nav">
      ...
      <style>{`
        ...
        @media (max-width: 900px) { .desktop-links { display: none; } }
      `}</style>
    </header>
  );
};
  ...
  return (
    <div className="home-container">
      ...
      <style>{`
        ...
        .copy { font-size: 10px; color: #ccc; }

        @media (max-width: 1000px) { .h-asymmetric { flex-direction: column; } .ha-box.small { display: none; } }
      `}</style>
    </div>
  );
};
    ...
    <div className="cat-root">
      ...
      <style>{`
        ...
        @media (max-width: 1000px) {
          .cat-root { flex-direction: column; }
          .cat-sidebar { position: relative; width: 100%; height: auto; border-right: none; padding: 50px 4vw; }
          .cat-grid { margin-left: 0; grid-template-columns: 1fr; }
        }
      `}</style>
    </div>
  );
  ...
  return (
    <div className="pd-root">
        ...
        <div className="pd-scroll-box">
          ...
          <div className="pd-section">
            ...
            <div className="spec-grid">
              {p.techSpecs.map(s => <div key={s} className="spec-item"><span>//</span> {s}</div>)}
            </div>
          </div>
      ...
      <style>{`
        ...
        .care-txt { font-size: 12px; font-style: italic; color: #888; margin-top: 15px; }
        ...
        @media (max-width: 1000px) {
          ...
          .pd-visual { height: 60vh; position: static; }
        }
      `}</style>
    </div>
  );
  ...
  return (
    <div className="bag-portal">
      ...
      <style>{`
        ...
        .bi-info button { background: none; border: none; font-size: 10px; font-weight: 900; text-decoration: underline; margin-top: 10px; }
    ...
    <VelosProvider>
      ...
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; cursor: none !important; }
        body { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif; background: #fff; color: #000; -webkit-font-smoothing: antialiased; }
